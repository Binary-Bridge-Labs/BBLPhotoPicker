//
//  BBLPhotoCollectionViewCell.swift
//  BBLPhotosPicker
//
...
open class BBLPlayerView: UIView {
...
open class BBLPhotoCollectionViewCell: UICollectionViewCell {
    private var observer: NSObjectProtocol?
    @IBOutlet open var imageView: UIImageView?
    @IBOutlet open var playerView: BBLPlayerView?
    ...
    deinit {
//        print("deinit BBLPhotoCollectionViewCell")
    }
