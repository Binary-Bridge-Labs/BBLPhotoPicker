...
open class BBLAlbumPopView: UIView, PopupViewProtocol {
...
//        print("deinit BBLAlbumPopView")
    ...
    override open func awakeFromNib() {
        ...
        self.tableView.register(UINib(nibName: "BBLCollectionTableViewCell", bundle: BBLBundle.bundle()), forCellReuseIdentifier: "BBLCollectionTableViewCell")
